# gloomwebapp
gloomwebapp is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
```bash
npm install gloomwebapp
```
## Usage

const Web3Tools = require('gloomwebapp');
